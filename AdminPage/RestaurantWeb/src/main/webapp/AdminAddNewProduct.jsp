                ...
                <div class="col-lg-6 border border-primary border-3 rounded-3">
                    ...
                    <form action="AdminAddNewProduct" method="post" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-3">
                            <input type="submit" class="btn btn-outline-primary" value="Add New Product">                            <a class="btn btn-outline-secondary" name="submit" href="AdminHomePage">Cancel Add New</a>
                        </div>
                    </form>
                </div>
            </div>
