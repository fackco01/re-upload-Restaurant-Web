                                    ...
                                    <c:forEach items="${listP}" var="p">
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">${p.nameP}</a></h3>
                                                ...
                                                <div class="product-btns">
                                                    ...
                                                    <button><a class="quick-view" href="Detail?id=${p.PID}"><i class="fa fa-eye"></i><span class="tooltipp">quick view</span></a></button>
                                                </div>
                                            </div>
