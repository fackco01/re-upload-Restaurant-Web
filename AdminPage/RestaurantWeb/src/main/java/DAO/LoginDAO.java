...
public class LoginDAO {
    ...
    public void NewAcc(String id, String usernamme, String password, String fullname, String roleId, boolean status) {
    ...
    public void updateAcc(String id, String usernamme, String password, String fullname, String roleId, boolean status) {
